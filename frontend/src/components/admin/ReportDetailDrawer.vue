...
<template>
  <Teleport to="body">
    ...
    >
      <aside
        v-if="open"
        class="fixed top-0 right-0 bottom-0 z-50 w-full max-w-md bg-white shadow-xl overflow-y-auto"
        role="dialog"
        aria-modal="true"
        ...
        <div v-if="report" class="flex flex-col h-full">
          ...
          <div class="flex-1 px-5 py-4 space-y-4">
            ...
            <section>
              ...
              <p class="text-sm font-medium text-gray-800">{{ report.reason }}</p>
              <p
                v-if="report.notes"
            ...
            <section>
              ...
              <p class="text-sm font-medium text-gray-800">{{ report.status }}</p>
            </section>
          ...
          <!-- Footer actions -->
          <div class="px-5 py-3 border-t border-gray-100 grid grid-cols-3 gap-2">
            <button
            ...
            <button
              class="col-span-3 px-3 py-2 text-sm font-medium text-green-700 border border-green-300 hover:bg-green-50 rounded-lg disabled:opacity-50"
              :disabled="acting"
              @click="markReviewed"
            >
              Mark Reviewed
